<template>
  <div style="width: 100%;height: 100vh;background-image: url('https://cdn.pixabay.com/photo/2023/10/02/14/51/shapes-8289322_1280.png');overflow: hidden">
    <el-card style="width: 400px;margin: 150px auto;">
      <div style="color: #409EFF;font-size: 30px;text-align: center;padding-bottom: 30px">欢迎登录</div>
      <el-form :model="form" size="normal" :rules="rules" ref="form" >
        ...
        <el-form-item >
          <el-button style="width: 100%;background-color: #409EFF;border-color:#409EFF; " type="primary" @click="login">登 录</el-button>
        </el-form-item>
        <el-form-item >
          <el-button style="width: 50%;margin-left: 25% ;background-color: #409EFF;border-color:#409EFF;" type="primary" @click="register">注 册</el-button>
        </el-form-item>
      </el-form>
    </el-card>
  </div>
...
export default {
  ...
  methods:{
    ...
    register(){
      this.$router.push("/register")//登录成功后进行页面跳转
    }
  }
